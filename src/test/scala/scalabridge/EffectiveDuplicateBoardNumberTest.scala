...
@Test
class EffectiveDuplicateBoardNumberTest extends UnitFlatSpec {
  ...
  "A EffectiveDuplicateBoardNumber" should "give the correct boardNumber" in {
    assertResult(EffectiveDuplicateBoardNumber.EIGHT)(
      EffectiveDuplicateBoardNumber.fromPositiveInteger(eight)
    )
    assertResult(EffectiveDuplicateBoardNumber.SIXTEEN)(
      EffectiveDuplicateBoardNumber.fromPositiveInteger(sixteen)
    )
  }
